...
import { QIANWEN_CONFIG } from './qianwen/data';
import { QianwenQuotaBody } from './qianwen/QianwenQuotaBody';
...
export const QUOTA_ADAPTERS: Record<QuotaProviderType, QuotaAdapter> = {
  ...
  qianwen: { ...QIANWEN_CONFIG, Body: QianwenQuotaBody } as unknown as QuotaAdapter,
